...
#install -m 644 "${ROOTFS_DIR}/usr/lib/aarch64-linux-gnu/libcamera.so.0.0.4" "${ROOTFS_DIR}/usr/lib/aarch64-linux-gnu/libcamera.so.0.0.3"
#install -m 644 "${ROOTFS_DIR}/usr/lib/aarch64-linux-gnu/libcamera-base.so.0.0.4" "${ROOTFS_DIR}/usr/lib/aarch64-linux-gnu/libcamera-base.so.0.0.3"
